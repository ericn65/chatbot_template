\# 🧠 Getting Started with \`chatbot\_template\`
...
## 0\. Installing needed parts

## **Install uv**

Before getting started, install uv on your system.
...
\`\`\`bash
git clone https://github.com/ericn65/chatbot\_template.git
cd chatbot\_template
\`\`\`
...
\`\`\`bash
uv run python \<path\_to\_entrypoint.py\>
\`\`\`

For example, if your main script is:

\`\`\`bash
uv run python scripts/run\_bot.py
\`\`\`
